...
include 'init.php';
  ...
  /*
   Start Daschboard Page
  */
   
  $numUsers = 6; // Numbers Of Latest Users
  ...
  <div class="col-sm-6">
    ...
    echo '<li style="display: flex; justify-content: space-between; align-items: center; padding: 10px;">';

        echo '<span>' . $user['Username'] . '</span>';

        
        echo '<div style="display: flex; gap: 5px; margin-left: auto;">';

            
            echo '<a href="members.php?do=Edit&userid=' . $user['UserID'] . '" class="btn btn-success">';
